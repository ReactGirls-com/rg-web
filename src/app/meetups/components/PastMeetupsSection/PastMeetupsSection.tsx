...
export const PastMeetupsSection = () => (
  <Section
    heading={
      <>
        {TRANSLATIONS.PAST_MEETUPS_SECTION_HEADING_BEFORE}{' '}
        <HeadingHighlight highlightColor={COLORS.aztecAtom}>
          {TRANSLATIONS.PAST_MEETUPS_SECTION_HEADING_HIGHLIGHT}
        </HeadingHighlight>
      </>
    }
  >
          ...
          <div className={style.cardContent}>
            <div>
              ...
              <p className={style.cardAuthor}>
                {TRANSLATIONS.PAST_MEETUPS_BY} {meetup.author}
              </p>
            </div>

            <Button variant="grapefruitPulp" href={meetup.videoUrl}>
              {TRANSLATIONS.PAST_MEETUPS_WATCH_BUTTON}
            </Button>
          </div>
        </BorderBox>
      ))}
