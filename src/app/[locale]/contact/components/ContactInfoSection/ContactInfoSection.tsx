...
export const ContactInfoSection: React.FC = async () => {
      ...
      <div className={style.boxesContainer}>
        ...
        >
          <a
            ...
            aria-label={`${t.CONTACT_INFO_EMAIL_LABEL} reactgirlsprague@gmail.com`}
          >
        ...
        <InfoBox
          title={t.CONTACT_INFO_ORGANIZATION_TITLE}
          iconClassName={style.iconCorporate}
          iconColor={COLORS.paleLavender}
        >
          <dl className={style.infoList}>
            <div className={style.infoRow}>
              <dt>{t.CONTACT_INFO_ORGANIZATION_NAME_LABEL}</dt>
              <dd>ReactGirls z. s.</dd>
            </div>
            <div className={style.infoRow}>
              <dt>{t.CONTACT_INFO_ORGANIZATION_ID_LABEL}</dt>
              <dd>09587535</dd>
            </div>
            <div className={style.infoRow}>
        ...
        <InfoBox
          title={t.CONTACT_INFO_BANK_TITLE}
        ...
        >
          <dl className={style.infoList}>
            ...
            <div className={style.infoRow}>
              <dt>{t.CONTACT_INFO_BANK_IBAN_LABEL}</dt>
              <dd>CZ3020100000002001890593</dd>
            </div>
            <div className={style.infoRow}>
              <dt>{t.CONTACT_INFO_BANK_SWIFT_LABEL}</dt>
              <dd>FIOBCZPPXXX</dd>
            </div>
          </dl>
        </InfoBox>
